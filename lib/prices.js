...
*/
var calculateDiscount = function (days) {
    ...
    var calculatedDiscount = discountDays.length * discountAmount;
...
calculateRegistrationPrice = function (registration) {
    ...
    if (registration.type === 'commuter') {
        ...
        if (registration.ageGroup && registration.days) {
            ...
            var calculatedDiscount = calculateDiscount(registration.days);

            //calculate the fee
            return dayFee * numberOfDays - calculatedDiscount;
        } else {
            // not enough detail
            return;
        }
