calculateRegistrationSubtotal = function (registration) {
  ...
  var registrationLinensFee; // Used for linens fee calculation
  ...
  try {
    registrationLinensFee = calculateLinensFee(registration);
  } catch (error) {
    console.log(error.message);
  }
  ...
  subtotal = accommodationsFee + registrationLinensFee - calculatedDiscount;
